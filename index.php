...
<!-- Full Page Header with Vertically Centered Content -->
	<header>
	  <div class="container h-100">
	    <div class="row h-100">
	      <div class="col-12 text-center header-caption">
	        <h1 class="display-3">Women's Soccer Club</h1>
	        <h2 class="display-5">University of Rochester</h2>
	      </div>
	    </div>
	  </div>
	</header>
		  ...
		  <main class="col-lg-8 p-5">
			...
			<aside class="col-lg-4 p-4 pt-5">
				<h3 class="pl-3">Executive Board</h3>
				 <ul>
						<li>Captain - Maddy Candela</li>
						<li>Business Manager - Delaney Martin</li>
						<li>Fundraising Chair: Divya Duraisamy</li>
						<li>Publicity Chair - Maddi Lang</li>
						<li>Social Chair - Sam Torrellas</li>
						<li>Social Chair - Rochelle Vassell</li>
				 </ul>
			</aside>
		</div>
	</div>
