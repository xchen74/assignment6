<?php $pageTitle="About | University of Rochester Women's Soccer Club "; include "inc/header.php"; ?>
	...
	<aside>
	   <ul>
	      <h1> Roster </h1>
	      <li>Alison Ciurzynski</li>
	      <li>Chloe Jones</li>
	      <li>Claire Cao</li>
	      <li>Delaney Martino</li>
	      <li>Divya Duraisamy</li>
	      <li>Emily Kumpf</li>
	      <li>Gianna Cicileo</li>
	      <li>Jessica Sgambati</li>
	      <li>Jessica Wood</li>
	      <li>Katie Simons</li>
	      <li>Kirsten Brownell</li>
	      <li>Kyra Majewski</li>
	      <li>Maddi Lang</li>
	      <li>Madelyn Candela</li>
	      <li>Maia Warner</li>
	      <li>Maria Mancheno</li>
	      <li>Michaela Farmer</li>
	      <li>Mimi Jung</li>
	      <li>Nipu Berger</li>
	      <li>Rebecca Friedman</li>
	      <li>Reena Caplash</li>
	      <li>Rochelle Vassell</li>
	   </ul>
	</aside>
